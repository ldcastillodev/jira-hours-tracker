      ...
      <nav className="border-b border-mgs-border bg-mgs-card-alt px-7 py-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-6">
            <span className="font-mono text-sm font-bold tracking-tight text-mgs-text">MgS</span>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `rounded-lg px-3 py-1.5 text-xs font-medium transition-colors ${
          isActive ? 'bg-mgs-card text-mgs-text' : 'text-mgs-text-dim hover:text-mgs-text-muted'
        }`
      }
    >
      {children}
