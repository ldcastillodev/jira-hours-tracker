...
import { ReportChart } from '../../organisms/ReportChart/ReportChart';
import { DownloadMenu } from '../../organisms/DownloadMenu/DownloadMenu';
import { DetailsPanel } from '../../organisms/DetailsPanel/DetailsPanel';
import type { FilterValues } from '../../organisms/FilterForm/FilterForm';
...
function DateRangeBadge({ period, startDate, endDate }: { period: 'day' | 'week' | 'month'; startDate: string; endDate: string }) {
  ...
  return (
    <div className="flex justify-center">
      <Badge className="rounded-full bg-[#ff8c00]/15 px-4 py-1.5 text-xs font-semibold text-[#ff8c00]">
        {formatRange()}
      </Badge>
    </div>
  );
